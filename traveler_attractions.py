...
test_traveler = ['Erin Wilkens', 'Shanghai, China',['historical site', 'art']]

attractions = [[] for empty_list in destinations]
...
add_attraction("Cairo, Egypt", ["Egyption museum", ["museaum"]])
